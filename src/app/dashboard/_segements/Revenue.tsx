...
import getChartColorsArray from '@/utils/getChartColorsArray';
import { useAppDispatch, useAppSelector } from '@/redux/app/hooks';

const Revenue = ({ dataColors }: { dataColors: string }) => {
    const dispatch = useAppDispatch();
    const [chartData, setchartData] = useState<any>([]);
    const [activeChart, setactiveChart] = useState<string>("yearly");

    // Inside your component
    const revenueChartData = useAppSelector(state => state.layout);
                    ...
                    <Card.Body className="p-0">
                        <div className="w-100">
                            <div id="revenue-chart" dir="ltr">
                                <ECharts option={options} echarts={series} />
                            </div>
                        </div>
                    </Card.Body>
                </Card>
