                        ...
                        <div className="p-3 border-bottom border-bottom-dashed">
                            <Row className="align-items-center">
                                ...
                                <Dropdown className="col-auto">
                                    <Dropdown.Toggle href="#" data-bs-toggle="dropdown" className="link-secondary fs-14 bg-transparent border-0 arrow-none"><i className="bi bi-three-dots-vertical"></i></Dropdown.Toggle>
                                    <Dropdown.Menu>
                                        <li><Dropdown.Item>All Clear</Dropdown.Item></li>
                                        <li><Dropdown.Item>Mark all as read</Dropdown.Item></li>
                                        <li><Dropdown.Item>Archive All</Dropdown.Item></li>
                                    </Dropdown.Menu>
                                </Dropdown>
                            </Row>
                        </div>
                    ...
                    <div className="py-2 ps-2" id="notificationItemsTabContent">
                        <SimpleBar style={{ maxHeight: "300px" }} className="pe-2">
                            ...
                            <div className="text-reset notification-item d-block dropdown-item position-relative unread-message">
                                <div className="d-flex">
                                    <div className="position-relative me-3 flex-shrink-0">
                                        <Image src={avatar2} className="rounded-circle avatar-xs" alt="user-pic" />
                            ...
                            <div className="text-reset notification-item d-block dropdown-item position-relative">
                                <div className="d-flex">
                                    ...
                                    <div className="position-relative me-3 flex-shrink-0">
                                        <Image src={avatar8} className="rounded-circle avatar-xs" alt="user-pic" />
                        ...
                        <div className="notification-actions" id="notification-actions">
                            <div className="d-flex text-muted justify-content-center align-items-center">
                                Select <div id="select-content" className="text-body fw-semibold px-1">0</div> Result <Button variant='link' type="button" className="btn btn-link link-danger p-0 ms-2" data-bs-toggle="modal" data-bs-target="#removeNotificationModal">Remove</Button>
                            </div>
                        </div>
                    </div>
                </Dropdown.Menu>
