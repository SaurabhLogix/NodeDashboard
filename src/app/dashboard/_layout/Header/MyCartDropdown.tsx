    ...
    return (
        <React.Fragment>
            <Dropdown className="topbar-head-dropdown ms-1 header-item">
                <Dropdown.Toggle id="cart-dropdown" type="button" className="btn btn-icon btn-topbar btn-ghost-dark rounded-circle arrow-none">
                    <i className='bi bi-bag fs-18'></i>
                    <span
                        className="position-absolute topbar-badge cartitem-badge fs-10 translate-middle badge rounded-pill bg-info">{cartItem}</span>
                </Dropdown.Toggle>
                <Dropdown.Menu className="dropdown-menu-xl dropdown-menu-end p-0 dropdown-menu-cart">
                    ...
                    <SimpleBar style={{ maxHeight: "300px" }}>
                        <div className="p-2">
                            <div className="text-center empty-cart" ref={emptyCart} style={{ display: "none" }}>
                            ...
                            {cartData.map((item, key) => (
                                <div className="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2" key={key}>
                                    <div className="d-flex align-items-center">
                                        <Image src={item.img} alt="user-pic" className='me-3 rounded-circle avatar-sm p-2 bg-light' />
                                        ...
                                        <div className="ps-2">
                                            <Button variant='light' type="button" className="btn btn-icon btn-sm btn-ghost-secondary remove-item-btn" onClick={(e) => { removeItem(e.target); }}><i
