...
import { Offcanvas, Collapse, Button } from "@bootstrap";
...
import {
    ...
    changePreLoader
    // resetValue
} from "../../../redux/features/dashboard/layout/thunk"
...
import {
    ...
    PERLOADER_TYPES
} from "../../../redux/features/dashboard/layout/layout";
...
const RightSidebar = () => {
    ...
    const {
        ...
        preloader
    } = useAppSelector(selectLayoutProperties);
