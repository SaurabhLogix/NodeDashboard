...
import { Col, Collapse, Row } from '@bootstrap';
                                                                    ...
                                                                    {!subItem.isChildItem ? (
                                                                        ...
                                                                        <li className="nav-item">
                                                                            <Link
                                                                                ...
                                                                                className="nav-link"
                                                                                href="/#"
                                                                                target={item.isBlankLink ? "_blank" : ""}
                                                                                data-bs-toggle="collapse"
                                                                            >
                                                                                {subItem.icon ? <React.Fragment><i className={subItem.icon}></i> <span>{props.t(subItem.label)}</span></React.Fragment> : props.t(subItem.label)}
                                                                            </Link>
                                                                                                                        ...
                                                                                                                        <React.Fragment key={key}>
                                                                                                                            {subSubChildItem.childItems ?
                                                                                                                                (<li className="nav-item apex" key={key}>
                                                                                                                                    ...
                                                                                                                                    {subSubChildItem.isChildItem && <Collapse className="collapse menu-dropdown" in={subSubChildItem.stateVariables}>
                                                                                                                                        <ul className="nav nav-sm flex-column">
                                                                                                                                            {subSubChildItem.childItems && (subSubChildItem.childItems || []).map((subSubChildItem: any, key: number) => (<li className="nav-item" key={key}>
                                                                                                                                                <Link href={subSubChildItem.link ? subSubChildItem.link : "/#"} className="nav-link">{props.t(subSubChildItem.label)}</Link>
                                                                                                                                            </li>))}
                                                                                                                                        </ul>
                                                                                                                                    </Collapse>}
                                                                                                                                </li>)
