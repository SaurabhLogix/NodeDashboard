...
export default function SubscriptionRightSidebar() {
    ...
    return (
        <Card style={{ minHeight: "calc(100vh - 70px - 60px - 142px)" }}>
            <Card.Body>
                <Link href="/dashboard/administrator/subscription/add"><Button variant='primary' type="button" className="w-100 addContact-modal" onClick={() => toggle()}><i className="bi bi-plus align-middle"></i> Add Contact</Button></Link>
