...
const AddRole = () => {
    const validation: FormikProps<RoleFields> = useFormik({
        ...
        <Tab.Container defaultActiveKey="personalDetails">
            <Row>
                <Col lg={9}>
                    <Card>
                        <Card.Header>
                            <h4 className="card-title mb-0">Role Information</h4>
                        </Card.Header>
                                ...
                                <Tab.Pane eventKey="personalDetails" title="personalDetails">
                                    <Form onSubmit={(e) => {
                                        ...
                                        <Row>
                                            <Col lg={6}>
                                                <InputContainer>
                                                    <FormLabel htmlFor="RoleName" className="form-label">Role Name <span className="text-danger">*</span></FormLabel>
                                                    <FormControl
                                                        type="text"
                                                        id="RoleName"
                                                        ...
                                                        isInvalid={validation.touched.RoleName && validation.errors.RoleName ? true : false}
                                                    />
                                                    <InputInvalidFeedback message={validation.errors?.RoleName} />
                                                </InputContainer>
                                            </Col>
                                            ...
                                            <Row>
                                                <Col lg={4}>
                                                    <div className="d-flex flex-wrap gap-2 mb-3 mb-lg-0">
                                                        ...
                                                        <Link href="/dashboard/administrator/role" className="btn btn-primary btn-label">
