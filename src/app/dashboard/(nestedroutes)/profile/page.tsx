...
import { Button, Card, Col, Container, Dropdown, Nav, Row, Tab } from '@bootstrap';
// import { simplePageProjectData } from '@common/data';
// import { simplePageProjectData } from './index';
                                                                    ...
                                                                    <Row className="g-3">
                                                                        ...
                                                                        <div className="col-auto">
                                                                            <div className="d-flex position-relative gap-2 border border-dashed p-2 rounded-3">
                                                                                ...
                                                                                <div className="flex-grow-1 ms-2">
                                                                                    <Link scroll={false} href="#" className="stretched-link">
                                                                                        <h6 className="mb-1 fs-12">Dev360 Invoice</h6>
                                                                                    </Link>
                                ...
                                <Card>
                                    <Card.Body>
                                        <Row>
                                            ...
                                            {([]).map((item: any, key: number) => (<Col xxl={3} sm={6} key={key}>
